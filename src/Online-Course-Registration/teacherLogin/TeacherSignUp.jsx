  ...
  return (
    <>
      <div className="font-[sans-serif] text-[#333]">
        <h1 className="text-center text-5xl md:py-8 md:font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-600 to-gray-600">
        ...
        <div className=" mt-32 flex fle-col items-center justify-center px-4 ">
          <div className="grid md:grid-cols-2  items-center justify-around gap-4 max-w-6xl w-full ">
            <div className=" rounded-md p-6 w-[80vw]  max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
              <form className="space-y-6">
                <div className="md:mb-16">
                  <h3 className="text-3xl font-extrabold">Teacher SignUp</h3>
                </div>
                <div>
                ...
                <div>
                  <label className="text-sm mb-3 block">Email ID</label>
                  <div className="relative flex items-center">
                    <input
                      name="emailID"
                      type="text"
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Link className="text-blue-500" to="/teacherLogin">
            ...
            <div className="lg:h-[400px] md:h-[700px] max-md:mt-10">
              <img
                src={image}
                className="w-full h-full object-cover invisible xl:visible"
